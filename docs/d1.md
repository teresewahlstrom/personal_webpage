# SOLVED
SOLVED
* removed a few dependencies that were no longer needed
* continued color streamlining/centralisation
* color renamings
* made the page spinner reusable in the page_scaffold instead of landing page specific

PERHAPS SOLVED (will verify after deployment)
* restored the keywords loader
...
# PROPOSED NEXT
* Make logo clickable
* Clickable color shared by links, buttons, logoThe dark link color should be more vibrant
...
* Make logo clickable + link color borders
...
* Projects should be clickable expandable rectangles. Default to minimized with only the title showing. Should have the same outline color as the clickable things

* Footer/header/keywords lines should be slightly brighter for light theme.
