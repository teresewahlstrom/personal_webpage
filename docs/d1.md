...
---
# SOON SOLVED
* the projects section should contain rectangles with the same style as the keywords graph frame - current content of the projects section should fill out the first rectangle, and then i will add more rectangles eventually
* scrolling by clicking on track did not work
