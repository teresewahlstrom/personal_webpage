...
- `tw_primitives`: shared theme, markdown, scroll, selection (custom `SelectableRegion` fork), panel, and pill primitives
- `hydrated_seo`: Static Site Generation (SSG) and Puppeteer pre-rendering engine for Flutter Web SEO
