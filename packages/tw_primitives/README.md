...
Provides a custom text selection engine derived from a fork of Flutter's `SelectableRegion` to resolve scroll-boundary clipping, bottom-to-top highlights, and web-scrolling deselection bugs. See the [selection README](file:///d:/flutter/personal_webpage/packages/tw_primitives/lib/src/selection/README.md) for full context and details on upstream bug fixes.
