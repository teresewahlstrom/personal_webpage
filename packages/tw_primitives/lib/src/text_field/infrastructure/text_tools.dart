...
DocumentSelection? getWordSelection({
  ...
  _log.fine('getWordSelection: docPosition=$docPosition');
  ...
  _log.fine('getWordSelection: wordSelection=$wordNodeSelection');
...
DocumentSelection? getParagraphSelection({
  ...
  _log.fine('getParagraphSelection: docPosition=$docPosition');
