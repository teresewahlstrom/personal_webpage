...
* **Resolving uncertainty before commitment – Volvo Cars, GE Additive, and Markforged:** Before a technology or application could be committed to, it was often genuinely unknown whether it could meet the application's requirements, whether the economics made sense, or what risks still needed to be resolved. Customers rarely asked whether additive manufacturing worked in general—they wanted to know whether **their** part could be manufactured to **their** specification with acceptable cost, quality, and production risk. Sometimes the uncertainty came from evaluating an unfamiliar technology or supplier. Sometimes it came from newly developed machines, materials, or applications operating beyond well-established capability.

  Terese designed benchmark programs and proof-of-concept studies as structured experiments that generated the evidence needed to answer those questions. Representative parts were manufactured, measured, analyzed, and discussed against the application's actual requirements. A benchmark here is evidence generation: a deliberately designed test of a specific hypothesis about feasibility, manufacturability, performance, or economics, built to reveal both capability and limitations before major commitments were made.
