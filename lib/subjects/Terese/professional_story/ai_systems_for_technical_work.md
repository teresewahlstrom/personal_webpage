...
* **Retrieval-backed professional knowledge system - Twin Tess:** As part of a broader exploration of evidence-grounded Al systems, she designed and built a structured digital-twin system based on her own professional experience. The project served as a practical environment for exploring retrieval, ranking, context assembly, source traceability, evaluation, and bounded-response strategies using real-world technical content. Behind the interface, the system combines sparse and dense retrieval, hybrid ranking, metadata-aware filtering, semantic routing, and structured context assembly to surface relevant source material. She also developed evaluation datasets, source-traceability mechanisms, and sufficiency checks that guide the system toward bounded fallback responses when the available evidence is incomplete
