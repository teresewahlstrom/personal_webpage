...
enum AppThemeDefault { dark, light, user }

final class AppRuntimeConfig {
  static const AppThemeDefault defaultTheme = AppThemeDefault.light;
...
final class ShellUiConfig {
  ...
  static const double headerLogoWidth = 54;
  static const double headerLogoHeight = 38;
...
final class ModalUiConfig {
  ...
  static const double capabilityHeaderHeight = 98;
